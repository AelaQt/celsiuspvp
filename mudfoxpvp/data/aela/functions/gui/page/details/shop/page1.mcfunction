...
item replace entity @s container.8 with bow{GUI:1,display:{Name:'{"text":"TBA","color":"yellow","italic":false}'}}
...
item replace entity @s container.16 with fishing_rod{GUI:1,display:{Name:'{"text":"TBA","color":"yellow","italic":false}'}}
