...
summon chest_minecart 5 63 5 {CustomNameVisible:1,Invulnerable:1,NoGravity:1,CustomName:'{"color":"yellow","text":"Menu"}',Tags:["gui"],Rotation:[0.0f,0.0f]}
summon chest_minecart -5 63 5 {CustomNameVisible:1,Invulnerable:1,NoGravity:1,CustomName:'{"color":"yellow","text":"Menu"}',Tags:["gui"],Rotation:[90.0f,0.0f]}
summon chest_minecart -5 63 -5 {CustomNameVisible:1,Invulnerable:1,NoGravity:1,CustomName:'{"color":"yellow","text":"Menu"}',Tags:["gui"],Rotation:[-180.0f,0.0f]}
summon chest_minecart 5 63 -5 {CustomNameVisible:1,Invulnerable:1,NoGravity:1,CustomName:'{"color":"yellow","text":"Menu"}',Tags:["gui"],Rotation:[-90.0f,0.0f]}
