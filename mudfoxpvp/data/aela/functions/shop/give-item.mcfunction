execute if entity @s[type=player] if score @s item matches 1 run give @s wooden_sword{Unbreakable:1}
...
execute if entity @s[type=player] if score @s item matches 41 run give @s spyglass
