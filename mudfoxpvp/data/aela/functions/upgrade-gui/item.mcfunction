...
execute if score @s item matches -1 if entity @s[nbt={Items:[{Slot:12b,id:"minecraft:golden_helmet"}]}] run scoreboard players set @s item 8
...
execute if score @s item matches -1 if entity @s[nbt={Items:[{Slot:12b,id:"minecraft:golden_chestplate"}]}] run scoreboard players set @s item 14
...
execute if score @s item matches -1 if entity @s[nbt={Items:[{Slot:12b,id:"minecraft:golden_leggings"}]}] run scoreboard players set @s item 20
...
execute if score @s item matches -1 if entity @s[nbt={Items:[{Slot:12b,id:"minecraft:golden_boots"}]}] run scoreboard players set @s item 26
