...
execute if score @s upgrade matches 106 run scoreboard players set @s cost 32
...
execute if score @s upgrade matches 306 run scoreboard players set @s cost 32
...
execute if score @s upgrade matches 406 run scoreboard players set @s cost 32
