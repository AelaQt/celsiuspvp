...
function aela:gui/page/details/purchase/slot4
...
item replace entity @s container.7 with black_stained_glass_pane{GUI:1,display:{Name:'{"text":""}'}}
...
function aela:gui/page/details/purchase/slot11
item replace entity @s container.12 with black_stained_glass_pane{GUI:1,display:{Name:'{"text":""}'}}
function aela:gui/page/details/purchase/slot13
...
function aela:gui/page/details/purchase/slot22
...
item replace entity @s container.25 with black_stained_glass_pane{GUI:1,display:{Name:'{"text":""}'}}
item replace entity @s container.26 with black_stained_glass_pane{GUI:1,display:{Name:'{"text":""}'}}